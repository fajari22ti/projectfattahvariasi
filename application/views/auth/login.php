...
<html lang="id-ID">
    ...
    <body>
        <div class="image" style="background-image: url('<?php echo get_theme_uri('images/logofattahh.png'); ?>');">
        <h1>Fattah Variasi</h1>
        ...
        <footer>
            <p class="copyright-agileinfo"> &copy; 2024 FATTAH VARIASI</p>
        </footer>
        </div>
    </body>
</html>