...
<!DOCTYPE html>
<html lang="en">
<div class="image2" style="background-image: url('<?php echo get_theme_uri('images/logofattahh.png'); ?>');">
<head>
    <!-- Required meta tags-->
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="page-wrapper  p-t-180 p-b-100 font-robo" style="background-image: url('<?php echo get_theme_uri('images/logofattah.png'); ?>');">>  
