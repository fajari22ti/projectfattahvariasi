...
<html lang="en">
  <head>
	...
	<link rel="icon" href="<?php echo base_url('assets/uploads/sites/L.png'); ?>">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
			...
			<li class="nav-item"><a href="<?php echo site_url('pages/partshop'); ?>"class="nav-link"><b>Partshop</b></a></li>
